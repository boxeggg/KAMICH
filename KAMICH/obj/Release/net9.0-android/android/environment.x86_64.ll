...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x06001a9e, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001a9d, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [810 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x1b6ca80582cf44c0, ; from name: libaot-KAMICH
		i64 u0x8e0c8e26d310f4ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-KAMICH.dll.so
		ptr null; void* handle
	}, ; 93
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x2cf8ad72f376e7c7, ; from name: aot-KAMICH.so
		i64 u0x8e0c8e26d310f4ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-KAMICH.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x32af49ac28eed87e, ; from name: aot-KAMICH
		i64 u0x8e0c8e26d310f4ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-KAMICH.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.56_name, ; name: libaot-System.Collections.Immutable.dll.so
		ptr null; void* handle
	}, ; 163
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x34ed17d61528300e, ; from name: KAMICH.dll.so
		i64 u0x8e0c8e26d310f4ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-KAMICH.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x61c078ae1e86a3fa, ; from name: KAMICH
		i64 u0x8e0c8e26d310f4ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-KAMICH.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x6da857f2f60d0a74, ; from name: KAMICH.so
		i64 u0x8e0c8e26d310f4ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-KAMICH.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8e0c8e26d310f4ab, ; from name: libaot-KAMICH.dll.so
		i64 u0x8e0c8e26d310f4ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-KAMICH.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb296e4d8df41bac1, ; from name: aot-KAMICH.dll.so
		i64 u0x8e0c8e26d310f4ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-KAMICH.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc4006eada3513d25, ; from name: libaot-KAMICH.so
		i64 u0x8e0c8e26d310f4ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-KAMICH.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [23 x i8] c"com.companyname.kamich\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [21 x i8] c"libaot-KAMICH.dll.so\00", align 16
...
@.DSOCacheEntry.56_name = private unnamed_addr constant [43 x i8] c"libaot-System.Collections.Immutable.dll.so\00", align 16
